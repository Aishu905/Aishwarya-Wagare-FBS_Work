...
class Test1 {
	...
	public static void main(String[] args) {
		...
		Vehicle v1=new Vehicle(101,"BMW","x5",4,120000);
		v1.Display();
		
		Bike b1=new Bike(102,"R15","yamha",2,150000,1,1,"Sports");
		b1.Display();
		
		Car c1=new Car(103,"Hyundai","Creta",4,210000,1,"On",1);
		c1.Display();
		
		Bus b2=new Bus(104,"Tata","StarBus",6,1100000,21,25);
		b2.Display();
	}
