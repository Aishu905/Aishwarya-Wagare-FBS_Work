...
class Test4 {
	...
	public static void main(String[] args) {
		Player p1=new Player("Virat Kohli",37,"India",550,18);
		p1.Display();

		CricketPlayer c1=new CricketPlayer("Rohit Sharma",39,"India",500,45,12000,20,"Righ hand batsman","Right arm off break");
		c1.Display();
		
		FootballPlayer f1=new FootballPlayer("Lionel Messi",39,"Argenita",1000,10,850,"Forward winger");
		f1.Display();
	}
